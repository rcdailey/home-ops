# Drive testing reference

Use this reference after loading the `drive-diagnostics` skill. Select tests based on the drive,
connection, intended use, and whether destructive testing was explicitly approved.

## 1. Preflight: Tool Installation and Capabilities

Run these checks immediately on command invocation. Stop and report a failed prerequisite.
