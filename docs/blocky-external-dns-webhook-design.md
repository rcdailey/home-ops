...
**Desired State:**
- Internal devices resolve `service.dailey.app` → `192.168.1.73` (internal gateway)
...
customDNS:
  mapping:
    ...
    grafana.dailey.app: 192.168.1.73
    home.dailey.app: 192.168.1.73
```
