...
**Records Deleted**: home.domain.example, torrent-test.domain.example, flux-webhook.domain.example, echo.domain.example, auth-test.domain.example
...
**External HTTPRoutes** (e.g., `app.domain.example`):
...
**Internal HTTPRoutes** (e.g., `dns.domain.example`):
...
# Test connectivity
curl -v https://dns-test.domain.example
